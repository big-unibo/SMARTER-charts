...
import SignalLineChart from "./components/signals-linechart-chart.ce.vue"
...
const signalLineChart = defineCustomElement(SignalLineChart)
...
export function registerChartComponents(){
    ...
    customElements.define("signals-linechart-chart-smarter", signalLineChart)
